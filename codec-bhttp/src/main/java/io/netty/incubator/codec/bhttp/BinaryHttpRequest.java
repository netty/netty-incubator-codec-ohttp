...
public interface BinaryHttpRequest extends HttpRequest {
    ...
    @Override
    BinaryHttpRequest setMethod(HttpMethod httpMethod);

    @Override
    BinaryHttpRequest setUri(String s);

    @Override
    BinaryHttpRequest setProtocolVersion(HttpVersion httpVersion);
}
