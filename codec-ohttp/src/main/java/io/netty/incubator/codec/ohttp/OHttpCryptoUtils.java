...
final class OHttpCryptoUtils {

    private OHttpCryptoUtils() { }
    ...
    static ByteBuffer aad(boolean isFinal) {
     ...
     */
    static ByteBuffer readableTemporaryBuffer(ByteBuf buf, int length) {
